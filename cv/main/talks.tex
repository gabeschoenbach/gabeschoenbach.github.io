...
\begin{itemize}
    \item \textbf{Optimal Hardness of Online Algorithms for Large Common Induced Subgraphs} \hfill 2026 \\\textsc{Conference on Learning Theory, NYU Student Probability Seminar, Columbia Theory Student Seminar, UChicago Theory Lunch Seminar}
    \item \textbf{Watermarking Language Models for Many Adaptive Users} \hfill 2025 \\ \textsc{IEEE Symposium on Security \& Privacy, Berkeley Security Seminar}
