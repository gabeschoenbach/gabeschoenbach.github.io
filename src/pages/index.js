      ...
      <div className="contentContainer">
        ...
        <div className="introContainer">
          <div className="intro">
            ...
            <div>
              <ul>
                <li><a href="https://github.com/mggg/ecological-inference">pyEI</a>, a Python package for ecological inference, a family of Bayesian hierarchical models often used to determine racial polarization in elections.</li>
